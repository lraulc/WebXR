...
class App {
  constructor() {
    ...
    this.camera.position.set(0, 4, 500);
  ...
  loadFBX() {
    ...
    loader.load(
      // resource URL
      "Mostro_Torso_Low.fbx",
      // called when the resource is loaded
      function (object) {
        self.mostro = object;
        self.material = new THREE.BasicMaterial({
          color: "0xff0000",
        });
